...
\begin{document}
\title{SB-GRPO: Semantic-Balanced GRPO \\ for Enhanced LLM Reasoning}

\author{Bang Dinh Nguyen\inst{1}* \and Bao Dang Tran\inst{1}* \and Minh Quoc Nguyen\inst{1}\thanks{Corresponding author.}}
...
\textbf{Case Study:} For a complex geometry problem, M-GRPO initially generated a correct rollout but "over-corrected" in Layer 2, changing the answer. In contrast, SB-GRPO's \textbf{Heuristic Confidence Gate} and \textbf{Entropy Scaling} identified the high certainty of the Layer 1 response, dampening the Layer 2 update and preserving the correct solution.
